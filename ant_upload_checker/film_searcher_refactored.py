...
class FilmSearcher:
    def __init__(self, film_list_df: pd.DataFrame, api_key: str, url: str):
    ...
    def check_if_film_exists_on_ant(self, film_title: str) -> list[dict[str, Any]]:
        ...
        title_checks = [
            (self.search_for_film_using_api, ""),
        ]
    ...
    def search_for_film_on_tmdb(self, film_title: str, release_year: str):
        ...
        response_json = self.search_for_film_using_api(payload)
    ...
    def search_for_film_using_api(self, payload: dict[str, str]) -> dict[Any, Any]:
        if not self.api_key:
            logging.error(
